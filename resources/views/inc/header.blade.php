<header>
    ...
    <h4 class="hidden-xs hidden-sm" style="position: absolute;left: 75px;top: 0;text-transform: capitalize;font-size: 14px;padding: 17px 0;">Bienvenido {{ urldecode($user->name . ' ' . $user->lastname) }}
</h4>
    <h4>{{ env('APP_NAME') }}</h4>
</header>